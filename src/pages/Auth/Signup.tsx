...
const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center p-6 relative overflow-hidden font-inter text-[#1C1C1C]" style={{ zoom: 0.85 }}>
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#A5D5D5]/20 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#F4C5C5]/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      >
        <button onClick={() => navigate('/')} className="mb-8 flex items-center gap-2 font-black uppercase tracking-widest text-sm hover:text-[#A5D5D5] transition-colors"><ArrowLeft size={16} strokeWidth={3} /> Back to Home</button>
        
        <div className="bg-white border-[3px] border-[#1C1C1C] rounded-[2rem] p-8 md:p-10 shadow-[12px_12px_0px_0px_#1C1C1C] relative">
          <div className="absolute -top-6 -right-6 w-16 h-16 bg-[#A5D5D5] border-[3px] border-[#1C1C1C] rounded-full flex items-center justify-center rotate-12 shadow-[4px_4px_0px_0px_#1C1C1C]">
            <Sparkles size={24} className="text-[#1C1C1C]" />
          </div>

          <h2 className="text-4xl font-black uppercase tracking-tighter leading-none mb-2">Join<br/>StudyLite</h2>
          <p className="font-bold opacity-70 mb-8 text-sm">Create your free account.</p>
          
          <form onSubmit={handleSignup} className="flex flex-col gap-5">
            <div className="relative">
              <label className="text-[10px] font-black uppercase tracking-widest absolute -top-2 left-4 bg-white px-1 text-[#1C1C1C] z-10">Name</label>
              <input 
                type="text" 
                ...
                required
                className="w-full bg-[#FDFBF7] border-[3px] border-[#1C1C1C] rounded-xl py-4 px-5 outline-none font-bold text-sm focus:bg-white focus:shadow-[4px_4px_0px_0px_#FBC343] transition-all placeholder:font-bold placeholder:text-[#1C1C1C]/30 relative z-0" 
              />
            </div>
            ...
            <div className="text-center text-xs font-black uppercase mt-4">
              <span className="opacity-50">Already have an account? </span>
              <Link to="/login" className="text-[#8FB8D9] hover:text-[#1C1C1C] hover:underline decoration-2 underline-offset-4 transition-all ml-1">Log in →</Link>
            </div>
          </form>
        </div>
      </motion.div>
