    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-cream px-6">
            <div className="max-w-md w-full bg-white rounded-3xl border-2 border-brandBlack p-8 shadow-xl">
                <h2 className="text-3xl font-bold mb-2 text-center text-brandBlack">Welcome Back</h2>
                ...
                <div className="relative flex items-center justify-center mb-8">
                    ...
                    <span className="relative bg-white px-4 text-xs font-bold text-brandBlack/40 uppercase">Or login with email</span>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <Link to="/forgot-password" title="Forgot password" className="text-xs text-brandPurple font-bold hover:underline">Forgot password?</Link>
                        </div>
                        <input
                            type="password"
                            required
                    ...
                    <div className="flex items-center gap-2">
                        <input type="checkbox" id="remember" className="accent-brandPurple" />
                        <label htmlFor="remember" className="text-sm font-medium opacity-60">Remember me</label>
                    </div>
                ...
                <p className="mt-8 text-center text-sm text-brandBlack/60">
                    Don't have an account? <Link to="/signup" className="text-brandPurple font-bold hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
    );
